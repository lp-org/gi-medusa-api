...
export class Role1686809962528 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "role_permissions_permission" ("roleId" character varying NOT NULL, "permissionId" character varying NOT NULL, CONSTRAINT "PK_b817d7eca3b85f22130861259dd" PRIMARY KEY ("roleId", "permissionId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "permission_roles_role" ("permissionId" character varying NOT NULL, "roleId" character varying NOT NULL, CONSTRAINT "PK_534958b0063b8ad39335d7bcfd0" PRIMARY KEY ("permissionId", "roleId"))`);
